...
describe('MetadataPage Component', () => {
    it('should not have any accessibility violations', async () => {
        const { container } = render(<MetadataPage onSubmit={() => { }} onBack={() => { }} onCancel={() => { }} />);
    ...
    it('renders the form title correctly', () => {
        ...
        expect(screen.getByRole('heading', { name: /Please provide information about this interview/i })).toBeInTheDocument();
    });
