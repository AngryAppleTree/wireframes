...
export const MetadataPage: React.FC<MetadataPageProps> = ({ onSubmit, onBack, onCancel }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (!formData.commissionerName.trim()) newErrors.commissionerName = 'Error: Please enter the commissioner name.';
        if (!formData.location.trim()) newErrors.location = 'Error: Please select an interview location.';
        if (!formData.witnessName.trim()) newErrors.witnessName = 'Error: Please enter the witness name.';
        if (!formData.interviewDate.trim()) newErrors.interviewDate = 'Error: Please enter the interview date.';
        ...
        <div className="metadata-page-container">
            ...
            <form className="metadata-form" onSubmit={handleSubmit}>
                <div className="form-group">
                    ...
                    <p className="metadata-input-subtext" id="commissionerName-hint">Enter the name of the commissioner who oversaw the witness interview</p>
                    <input
                        id="commissionerName"
                ...
                <div className="form-group">
                    ...
                    <p className="metadata-input-subtext" id="location-hint">In which city did the interview take place</p>
                    <select
                        id="location"
                        name="location"
                ...
                <div className="form-group">
                    ...
                    <p className="metadata-input-subtext" id="witnessName-hint">Enter the name of the witness</p>
                    <input
                        id="witnessName"
                        name="witnessName"
                        type="text"
                ...
                <div className="form-group">
                    ...
                    <p className="metadata-input-subtext" id="interviewDate-hint">Enter the date the interview.</p>
                    <input
                        id="interviewDate"
                        name="interviewDate"
                        type="date"
                ...
                <div className="form-group">
                    ...
                    <p className="metadata-input-subtext" id="caseRef-hint">Enter the case reference.</p>
                    <input
                        id="caseRef"
                        name="caseRef"
                        type="text"
