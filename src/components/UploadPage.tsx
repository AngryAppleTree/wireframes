  ...
  return (
    <div className="upload-page-container">
      ...
      <p className="upload-description">
        Choose a file from your computer or device that contains the recording of the Evidence by
      ...
      <div className="upload-actions">
        ...
        <Button onClick={handleUploadClick} aria-label="Upload selected file">
          Upload and Continue
        </Button>

        <Button variant="secondary" onClick={onCancel} aria-label="Cancel and go back">
          Cancel
        </Button>
      </div>
    </div>
